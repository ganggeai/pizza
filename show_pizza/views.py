...
def index(request):
    ...
    total_sold_pizzas=Transactions.objects.values('pizza_id').distinct().count()
    ...
    for index,pizza in enumerate(pizzas_sold_count):
        ...
        pizzas.append(pizza)
    return  render(request,'index.html',{'pizzas':pizzas,'total_sold_pizzas':total_sold_pizzas,'total_sold_amount':total_sold_amount,'time_zone':time_zone})
